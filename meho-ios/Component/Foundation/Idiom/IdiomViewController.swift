...
class IdiomViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MehoAnalytics {
    ...
    private lazy var idioms: [Idiom] = {
        ...
        let csml = Idiom.init(title: "车水马龙", explanation: "wagons, vehicles", backgroundImageURL: csmlImageURL!, audioURL: csmlAudioURL!, firstWord: "车:", firstWordExplanation: "wagons, vehicles", secondWord: "水:", secondWordExplanation: "water, flow", thirdWord: "马:", thirdWordExplanation: "water, flow", fourthWord: "龙:", fourthWordExplanation: "dragon, a continuous stream")
